 ...
 */
namespace FacturaScripts\Plugins\CloudGallery\Lib;
...
final class AppRouter
{
    ...
    public function getFile(): bool
    {
        ...
        /// Allowed folder?
        $allowedFolders = ['node_modules', 'vendor', 'Dinamic', 'Core', 'Plugins', 'MyFiles/Public', 'MyFiles/Public/2021m/3'];
    ...
    public static function isFileSafe(string $filePath): bool
    {
        ...
        return \in_array(\end($parts), $safe, true) == false ? stristr(implode('', $safe), \end($mime)) == false ? false : true : true;
    }
