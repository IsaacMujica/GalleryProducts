 ...
 */
abstract class ListGalleryController extends Lib\ExtendedController\BaseController
{
    ...
    protected function addView($viewName, $modelName, $viewTitle = '', $icon = 'fas fa-search')
    {
        ...
        $view = new ListGalleryView($viewName, $title, self::MODEL_NAMESPACE . $modelName, $icon);
