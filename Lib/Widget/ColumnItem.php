 ...
 */
class ColumnItem extends CoreWidget\VisualItem
{
    ...
    public function __construct($data)
    {
        ...
        $this->tooltip = isset($data['tooltip']) ? $data['tooltip'] : false;
    ...
    {
        return $this->tooltip === false ? '' : $this->widget->tooltipTitleValue($model, static::$i18n->trans($this->title));
    }
