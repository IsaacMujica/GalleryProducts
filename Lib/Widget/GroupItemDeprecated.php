 ...
 */
class GroupItem extends CoreWidget\VisualItem
{
    ...
    {
        $columnClass = CoreWidget\VisualItemLoadEngine::getNamespace() . 'ColumnItem';
        foreach ($children as $child) {
            if (/*$child['tag'] !== 'columnGallery' && */$child['tag'] !== 'column') {
                continue;
            }

            /*if ($child['tag'] === 'columnGallery')
                $columnClass = CoreWidget\VisualItemLoadEngine::getNamespace() . 'ColumnGallery';
            elseif ($child['tag'] === 'column')
                $columnClass = CoreWidget\VisualItemLoadEngine::getNamespace() . 'ColumnItem';*/
