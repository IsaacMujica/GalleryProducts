 ...
 */
class AttachedFile extends \FacturaScripts\Core\Model\Base\ModelClass
{
    ...
    protected function setFile()
    {
        ...
        $path = 'MyFiles' . DIRECTORY_SEPARATOR . 'Public' . DIRECTORY_SEPARATOR . \date('Y' . DIRECTORY_SEPARATOR . 'm', \strtotime($this->date));
    ...
    public function DatosArchivo()
    {
        $model = new DatosArchivo();
        $model->loadFromCode('', [new DataBaseWhere('mime', '%' . $this->mimetype . '%', 'LIKE')]);
        return $model;
    }
    ...
    public function GrupoArchivo()
    {
        ...
        $model->loadFromCode('', [new DataBaseWhere('extension', '%' . $this->getExtension() . '%', 'LIKE')]);
        return $model;
    }

    public function getExtension()
    {
        $fullPathFile = explode(".", $this->filename);
        return end($fullPathFile);
    }
}
